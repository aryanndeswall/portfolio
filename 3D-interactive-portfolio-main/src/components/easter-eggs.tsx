...
const EasterEggs = () => {
  ...
  useEffect(() => {
    ...
    if (typeof console !== "undefined") {
      ...
      ["naresh", "Naresh", "NARESH", "aaditya", "Aaditya", "AADITYA"].forEach((name) => {
        // @ts-ignore
        if (Object.hasOwn(window, name)) return;
        Object.defineProperty(window, name, {
          get() {
            const isAaditya = name.toLowerCase() === "aaditya";
            console.log(
              `%c✨ Abra Kadabra! ✨\n\n` +
                `You just summoned the magic of ${isAaditya ? "Aaditya" : "Naresh"}! 🧙‍♂️\n` +
