...
const AnimatedBackground = () => {
  ...
  const handleSplineInteractions = () => {
    ...
    // Debounce mouse hover to reduce excessive state updates → less lag
    let hoverTimeout: ReturnType<typeof setTimeout> | null = null;
    const debouncedHover = (e: SplineEvent) => {
      if (hoverTimeout) clearTimeout(hoverTimeout);
      hoverTimeout = setTimeout(() => handleMouseHover(e), 30);
    };
    ...
    splineApp.addEventListener("mouseHover", debouncedHover);
  };
